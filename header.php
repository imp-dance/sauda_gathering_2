...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    { 
        ...
        <div class="navbar-right">
            <span>Du er logget inn som <strong><a href="profile.php"><?php echo($_SESSION['user']['username']); ?></a></strong> <?php if(isset($_SESSION['user']['type'])){} if ($_SESSION['user']['type'] == "crew"){ echo("(crew)"); } ?> &raquo;</span>
            ...
            <a href="irc.php"><button class="btn btn-danger moveman redi"><span class="glyphicon glyphicon-comment"></span> IRC</button></a>
            </div>
        <?php
    }
        ?>
